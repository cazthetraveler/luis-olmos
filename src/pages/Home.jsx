    ...
    <main className="home-page">
      <section className="home">
        ...
        <section className="about-me">
          <h1>Welcome!</h1>
          <p>
            Hi, my name is Luis Olmos and I am a graphic designer, web
          ...
          <p>
            ...
            web development, so I enrolled and finished a 6-month bootcamp
            course from the University of Texas at San Antonio. I completed the
            course in February 2024, where I received my certificate of
            completion.
          </p>
          <p>
